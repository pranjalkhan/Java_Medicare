...
public class bpositive extends JFrame implements ActionListener
{
	JPanel panel;
	Color mycolor;
	Font myfont;
	private JButton backButton;
	private JLabel bloodLabel7;
	ImageIcon imgbl7;
	public bpositive()
	{
		super("Blood donor");
        ...
        add(backButton);
		imgbl7 = new ImageIcon("blood\\Blood.jpg");
		bloodLabel7 = new JLabel(imgbl7);
		bloodLabel7.setBounds(0,0, 1200, 691);
		panel.add(bloodLabel7);
