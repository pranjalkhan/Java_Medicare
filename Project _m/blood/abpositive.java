...
public class abpositive extends JFrame implements ActionListener
{
	JPanel panel;
	Color mycolor;
	Font myfont;
	...
	public abpositive()
	{
		...
		JLabel usernameLabel1 = new JLabel("Name :Pasha Vai");
		...
		JLabel usernameLabel4 = new JLabel("Name :Shimul");
