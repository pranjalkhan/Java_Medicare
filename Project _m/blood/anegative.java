...
public class anegative extends JFrame implements ActionListener
{
	JPanel panel;
	Color mycolor;
	Font myfont;
	private JButton backButton;
	private JLabel bloodLabel3;
	ImageIcon imgbl3;
	public anegative()
	{
		super("Blood donor");
		...
		JLabel usernameLabel1 = new JLabel("Name :Samiul");
		...
		imgbl3 = new ImageIcon("blood\\Blood.jpg");
		bloodLabel3 = new JLabel(imgbl3);
		bloodLabel3.setBounds(0,0, 1200, 691);
		panel.add(bloodLabel3);
