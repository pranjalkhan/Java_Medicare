...
public class onegative extends JFrame implements ActionListener {
    JPanel panel;
    Color mycolor;
	Font myfont;
    private JButton backButton;
	private JLabel bloodLabel13;
	ImageIcon imgbl13;
    public onegative() {
        super("Blood donor");
        setSize(1200,691);
        ...
        JLabel usernameLabel1 = new JLabel("Name: Tomal");
        ...
        JLabel usernameLabel4 = new JLabel("Name: Purnandu Bikash Das");
        ...
        add(backButton);
        imgbl13 = new ImageIcon("blood\\Blood.jpg");
		bloodLabel13 = new JLabel(imgbl13);
		bloodLabel13.setBounds(0,0, 1200, 691);
		panel.add(bloodLabel13);
        this.add(panel);
    }
