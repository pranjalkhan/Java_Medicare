...
public class bnegative extends JFrame implements ActionListener
{
	JPanel panel;
	Color mycolor;
	Font myfont;
	private JButton backButton;
	private JLabel bloodLabel6;
	ImageIcon imgbl6;
	public bnegative()
	{
		super("Blood donor");
		...
		JLabel usernameLabel4 = new JLabel("Name :Mostafiz");
        ...
        add(backButton);
		imgbl6 = new ImageIcon("blood\\Blood.jpg");
		bloodLabel6 = new JLabel(imgbl6);
		bloodLabel6.setBounds(0,0, 1200, 691);
		panel.add(bloodLabel6);
