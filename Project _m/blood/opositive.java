...
public class opositive extends JFrame implements ActionListener
{
	JPanel panel;
	Color mycolor;
	Font myfont;
	private JButton backButton;
	private JLabel bloodLabel14;
	ImageIcon imgbl14;
	public opositive()
	{
		super("Blood donor");
		...
		JLabel usernameLabel1 = new JLabel("Name :Imrul ");
		...
		JLabel usernameLabel4 = new JLabel("Name :Kayes");
		...
		imgbl14 = new ImageIcon("blood\\Blood.jpg");
		bloodLabel14 = new JLabel(imgbl14);
		bloodLabel14.setBounds(0,0, 1200, 691);
		panel.add(bloodLabel14);
