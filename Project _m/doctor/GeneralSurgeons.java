...
public class GeneralSurgeons extends JFrame implements ActionListener {
	JPanel panel;
	...
	public GeneralSurgeons() {
		...
		imgG = new ImageIcon("Homepage\\doc.jpg");
		label6 = new JLabel(imgG);
