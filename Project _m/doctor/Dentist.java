...
public class Dentist extends JFrame implements ActionListener {
	...
	public Dentist() {
		...
		a1 = new JLabel("Dr. Fahim Abrar");
		a1.setBounds(100, 100, 500, 20);
		a1.setFont(myfont);
		panel.add(a1);

		a2 = new JLabel("Dentist");
		...
		a4 = new JLabel("Dr. Eti Skikdar");
		a4.setBounds(100, 180, 500, 20);
		a4.setFont(myfont);
		panel.add(a4);

		a5 = new JLabel("Dentist");
		...
		imgdn = new ImageIcon("Homepage\\doc.jpg");
		label6 = new JLabel(imgdn);
